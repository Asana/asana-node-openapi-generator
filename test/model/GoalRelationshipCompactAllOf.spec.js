...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Asana.GoalRelationshipCompactAllOf();
  });
  ...
  describe('GoalRelationshipCompactAllOf', function() {
    it('should create an instance of GoalRelationshipCompactAllOf', function() {
      ...
      //var instance = new Asana.GoalRelationshipCompactAllOf();
      //expect(instance).to.be.a(Asana.GoalRelationshipCompactAllOf);
    });

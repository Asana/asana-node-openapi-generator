...
export default class AuditLogAPIApi {
    ...
    */
     ...
     * @param {String} opts.eventType Filter to events of this type. Refer to the [Supported AuditLogEvents](/docs/supported-auditlogevents) for a full list of values.
